              ...
              <div className="hidden md:block">
                <Card className="bg-card/60 backdrop-blur">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Access your account to view orders and earn rewards
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="bg-muted/50">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>
                    Customize your coffee just the way you like it
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Choose your size, milk type, syrups, and more to create your
                    perfect drink.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-muted/50">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Join our loyalty program to earn points and unlock exclusive
                    rewards.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-muted/50">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Simply scan the QR code on your table to place an order
          ...
          <div className="container px-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Access your orders and earn rewards
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Send a digital gift card to a friend or loved one. Perfect for
                  birthdays, thank yous, or just because.
                </p>
                <Button asChild size="lg" className="font-medium">
